import { createTransactionData, getTransactionData } from "../odm/transaction.js";
        ...
        const [updateTransactionResponse] = await Promise.all( 
            [
                createTransactionData({
                    ...
                    type: ( parseFloat(req.body.amount) > 0 ? utilityConstants.enums.transactionTypeObject.credit : utilityConstants.enums.transactionTypeObject.debit)
                }),
...
export const getTransactions = async (req, res) => {
    try {
        ...
        console.log( { [req.query.sortBy]: req.query.orderBy });
        const walletData = await getTransactionData(
            req.query.limit ? parseFloat(req.query.limit) : 10,
